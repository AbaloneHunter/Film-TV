# coding: utf-8
# == Site Info ==
# 站点: 蝶卡影视网 (diekawang.com)
# 站型: HTML影视站 (Nuxt.js SSR + jQuery)
# 列表路由: /vod/list/{page}/{parent_type}/{sub_type}
# 详情路由: /vod/player/0/{vod_id} (播放页即详情页)
# 搜索路由: /public/auto/search1.html?keyword={keyword}
# 播放解码: file[3:] -> base64decode -> URLunquote -> m3u8直链
# 回归样本:
#   分类页: /vod/list/1/1/0 (电影), /vod/list/1/2/0 (电视剧)
#   详情页: /vod/player/0/105083 (百花杀 31集), /vod/player/0/108218 (电影)
#   搜索词: 吞没, 百花杀
#   播放样本: 0MkaHR0cHM6JTJGJTJGY2Ru... -> https://cdn.yzzy32-play.com/.../index.m3u8
# == End Site Info ==
